...
export default function Portofolio() {
  ...
  return (
    <div className="container md:h-[300vh] h-auto w-screen">
      <div className="startPorto h-[50vh] w-screen md:p-10 p-2 md:mb-10 mb-2">
        <div className="diff md:aspect-[16/9] h-[50vh]">
      ...
      <div className="content md:h-screen h-auto w-screen flex flex-grow flex-col md:flex-row justify-between md:mt-20 md:p-10 p-2">
        {/* Card Left */}
        ...
        <div className="w-full flex justify-center align-center mt-10  ">
          {/* Carousel Vertikal */}
          <div className="carousel carousel-vertical rounded-box md:h-[90%] h-[50vh] md:w-3/2 w-[85%] mt-10 hidden md:block">
            <div
